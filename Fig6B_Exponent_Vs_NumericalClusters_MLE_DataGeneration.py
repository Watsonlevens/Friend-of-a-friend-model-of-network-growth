...
#Random probabilities used in simulations
#openfile = open('probs.pkl', 'rb') 
#prob = pickle.load(openfile)

N =10000
m0 = 3
 ##A function for generating network
...
##        #For coloring
        ...
        if max_k > 3:        
            ...
            #Numericalclusters.append(clustering)
        else :
            continue
#

# 
## Saving the exponents
#######################################################################################################################
#fileName   =  'alpha_exponent_Numerical' + ".pkl";
#file_pi = open(fileName, 'wb') 
#pickle.dump(alpha_exponent_Numerical, file_pi)
########################################################################################################################
## #Saving the clustering
######################################################################################################################
#fileName   =  'Numericalclusters' + ".pkl";
#file_pi = open(fileName, 'wb') 
#pickle.dump(Numericalclusters, file_pi)
#########################################################################################################################            
##
####Numerical results. Opening the degrees
#########################################################################################################################
#openfile = open('alpha_exponent_Numerical.pkl', 'rb') # N = 100000 for 1000 runs
#alpha_exponent_Numerical = pickle.load(openfile)          # p = 0, q = 1
######################################
#
#
###Numerical results. Opening the degrees
#########################################################################################################################
#openfile = open('Numericalclusters.pkl', 'rb') # N = 100000 for 1000 runs
#Numericalclusters = pickle.load(openfile)          # p = 0, q = 1
######################################
...
ax.set_xlim(0,1)
ax.set_ylim(0, 10)
#plt.savefig('Exponent_clustering_numerical_Maxlikelhood.pdf')
##
##
#
#
